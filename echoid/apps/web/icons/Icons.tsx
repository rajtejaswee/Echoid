...
export const LightMode = ({ className }: IconProps) => {
  return (
    <svg
      ...
      className={className}
    >
      <rect width="50" height="50" fill="url(#pattern0_264_1278)" />
      <defs>
        <pattern
          id="pattern0_264_1278"
          patternContentUnits="objectBoundingBox"
          width="1"
          height="1"
        >
          <use xlinkHref="#image0_264_1278" transform="scale(0.0128205)" />
        </pattern>
        <image
          id="image0_264_1278"
          width="78"
...
export const NightMode = ({ className }: IconProps) => {
  return (
    <svg
      width="39"
      height="39"
      ...
      className={className}
    >
      <rect width="39" height="39" fill="url(#pattern0_262_1025)" />
      <defs>
        <pattern
          id="pattern0_262_1025"
          patternContentUnits="objectBoundingBox"
          width="1"
          height="1"
        >
          <use xlinkHref="#image0_262_1025" transform="scale(0.02)" />
        </pattern>
        <image
          id="image0_262_1025"
          width="50"
          height="50"
          preserveAspectRatio="none"
          xlinkHref="data:image/png;base64,"
        />
      </defs>
    </svg>
  );
...
export const Hand = ({ className }: IconProps) => {
  return (
    <svg
      width="71"
      height="60"
  ...
  return (
    ...
    >
      <g clip-path="url(#clip0_262_755)">
        ...
        />
        <path
          d="M9.68988 19.0006C12.2521 19.0006 14.4128 18.1594 15.9871 16.7072L12.9258 14.3335C12.074 14.913 10.9745 15.2411 9.69337 15.2411C7.21496 15.2411 5.11354 13.5691 4.35954 11.321H1.20044V13.768C2.81315 16.976 6.09792 19.0006 9.68988 19.0006Z"
          fill="#34A853"
        />
        <path
          d="M4.35636 11.321C3.95842 10.1412 3.95842 8.86355 4.35636 7.68369V5.23669H1.20075C-0.146669 7.92106 -0.146669 11.0837 1.20075 13.768L4.35636 11.321Z"
          fill="#FBBC04"
        />
        <path
          d="M9.68988 3.76015C11.0443 3.7392 12.3533 4.24885 13.3342 5.18436L16.0465 2.47207C14.329 0.859358 12.0496 -0.0272856 9.68988 0.000640194C6.09792 0.000640194 2.81315 2.02526 1.20044 5.23672L4.35605 7.68372C5.10656 5.4322 7.21146 3.76015 9.68988 3.76015Z"
          fill="#EA4335"
        />
      </g>
      <defs>
        <clipPath id="clip0_262_755">
